...
class Image(db.Model):
    ...
    album_images = db.relationship('AlbumImage', backref='image', lazy=True, cascade='all, delete-orphan')
...
class Album(db.Model):
    ...
    # Relationships
    album_images = db.relationship('AlbumImage', backref='album', lazy=True, cascade='all, delete-orphan')
